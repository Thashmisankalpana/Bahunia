...
@section('content')
    ...
    <div class="container">
        <form action = "/check" method = "POST" class="form-group" style="width:40%; margin-left:30%;">
            ...
            <p class="sign-up">Don't have an Account?<a href="/register" id="contain3"> Register</a></p>
            <p class="sign-up">If You are Admin.Login This--><a href="/Alogin" id="contain3">Login</a></p>
